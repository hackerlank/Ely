...
/**
 * P3Sound3d is a PandaNode class designed for the audio of
 * translation/rotation movements. To be driven, a PandaNode object should be
 * attached to this P3Sound3d.\n
 *
 * P3Sound3d can be enabled/disabled as a whole (enabled by default).\n
 * P3Sound3d can handle a given basic movement (forward, backward, head_left,
