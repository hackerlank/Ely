...
void TutorialApplication::createScene(void)
{
	...
	Ogre::SceneNode* nodeNinja =
			mSceneMgr->getRootSceneNode()->createChildSceneNode();
	nodeNinja->attachObject(entNinja);
	nodeNinja->lookAt(Ogre::Vector3(0, 0, 1500), Ogre::Node::TS_LOCAL);

	Ogre::Plane plane(Ogre::Vector3::UNIT_Y, 0);
	Ogre::MeshManager::getSingleton().createPlane("ground",
			Ogre::ResourceGroupManager::DEFAULT_RESOURCE_GROUP_NAME, plane,
			5000, 5000, 20, 20, true, 1, 5, 5, Ogre::Vector3::UNIT_Z);
	...
	//	pointLight->setAttenuation(1500.0,0.1,0.0,0.0);
