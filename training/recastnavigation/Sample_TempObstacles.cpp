...
//
/**
 * \file /Ely/training/recastnavigation/Sample_TempObstacles.cpp
 *
 * \date 2013-04-29
 * \author consultit
 */
...
dtTileCache* Sample_TempObstacles::getTileCache()
{
	return m_tileCache;
}

void Sample_TempObstacles::setTileSettings(const TileSettings& settings)
{
...
TileSettings Sample_TempObstacles::getTileSettings()
{
