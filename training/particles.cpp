...
static std::string ptfFile(
		"/REPOSITORY/KProjects/WORKSPACE/panda_test.py/particles/shoot.ptf");

//fake GameManager definition
namespace ely
{
...
int particles_main(int argc, char *argv[])
{
	...
	///XXX fake GameManager singleton
	ely::GameManager* gameMgr = new ely::GameManager();
	///
