...
////////////////////////////////////////////////////////////////////
class BulletHingeConstraint: public BulletConstraint
{
...
public:
	...
	BulletHingeConstraint(const BulletRigidBodyNode *node_a,
			...
			const LPoint3 &pivot_b, const LVector3 &axis_a,
			const LVector3 &axis_b, bool use_frame_a = false);

	BulletHingeConstraint(const BulletRigidBodyNode *node_a,
			const TransformState *ts_a, bool use_frame_a = false);
	BulletHingeConstraint(const BulletRigidBodyNode *node_a,
			const BulletRigidBodyNode *node_b, const TransformState *ts_a,
			const TransformState *ts_b, bool use_frame_a = false);
	...
	void set_limit(PN_stdfloat low, PN_stdfloat high, PN_stdfloat softness =
			0.9f, PN_stdfloat bias = 0.3f, PN_stdfloat relaxation = 1.0f);
	void set_axis(const LVector3 &axis);

	void enable_angular_motor(bool enable, PN_stdfloat target_velocity,
...
//  Description:
////////////////////////////////////////////////////////////////////
inline BulletHingeConstraint::~BulletHingeConstraint()
{
