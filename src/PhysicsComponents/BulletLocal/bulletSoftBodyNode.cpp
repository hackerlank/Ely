...
#include "PhysicsComponents/BulletLocal/bulletSoftBodyShape.h"
...
//  Description:
////////////////////////////////////////////////////////////////////
BulletSoftBodyNode::BulletSoftBodyNode(btSoftBody *body, const char *name) :
		BulletBodyNode(name)
{
...
//  Description:
////////////////////////////////////////////////////////////////////
btCollisionObject *BulletSoftBodyNode::get_object() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
BulletSoftBodyConfig BulletSoftBodyNode::get_cfg()
{
...
//  Description:
////////////////////////////////////////////////////////////////////
BulletSoftBodyWorldInfo BulletSoftBodyNode::get_world_info()
{
...
//  Description:
////////////////////////////////////////////////////////////////////
int BulletSoftBodyNode::get_num_materials() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
BulletSoftBodyMaterial BulletSoftBodyNode::append_material()
{
...
//  Description:
////////////////////////////////////////////////////////////////////
int BulletSoftBodyNode::get_num_nodes() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
void BulletSoftBodyNode::generate_bending_constraints(int distance,
...
//  Description:
////////////////////////////////////////////////////////////////////
void BulletSoftBodyNode::randomize_constraints()
{
...
//  Description:
////////////////////////////////////////////////////////////////////
void BulletSoftBodyNode::transform_changed()
{
	...
	if (!m_sync.almost_equal(m_ts))
	{
		...
		btVector3 pos = LVecBase3_to_btVector3(
				this->get_aabb().get_approx_center());
		...
		if (ts->has_scale())
		{
			btVector3 current_scale = LVecBase3_to_btVector3(
					_sync->get_scale());
...
//  Description:
////////////////////////////////////////////////////////////////////
void BulletSoftBodyNode::sync_p2b()
{
...
//  Description:
////////////////////////////////////////////////////////////////////
void BulletSoftBodyNode::sync_b2p()
{
	...
	if (_geom)
	{
		...
		while (!vertices.is_at_end())
		{
			...
			if (flips.get_data1i() > 0)
				n *= -1;

			vertices.set_data3((PN_stdfloat) v.getX(), (PN_stdfloat) v.getY(),
					(PN_stdfloat) v.getZ());
			normals.set_data3((PN_stdfloat) n.getX(), (PN_stdfloat) n.getY(),
					(PN_stdfloat) n.getZ());
		}
	}
...
//  Description: 
////////////////////////////////////////////////////////////////////
void BulletSoftBodyNode::unlink_geom()
{
...
//  Description: 
////////////////////////////////////////////////////////////////////
void BulletSoftBodyNode::unlink_curve()
{
...
//  Description: 
////////////////////////////////////////////////////////////////////
void BulletSoftBodyNode::unlink_surface()
{
...
//  Description:
////////////////////////////////////////////////////////////////////
BoundingBox BulletSoftBodyNode::get_aabb() const
{
	...
	return BoundingBox(btVector3_to_LPoint3(pMin), btVector3_to_LPoint3(pMax));
}
...
//  Description:
////////////////////////////////////////////////////////////////////
void BulletSoftBodyNode::set_total_mass(PN_stdfloat mass, bool fromfaces)
{
...
//  Description:
////////////////////////////////////////////////////////////////////
PN_stdfloat BulletSoftBodyNode::get_total_mass() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
PN_stdfloat BulletSoftBodyNode::get_volume() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
void BulletSoftBodyNode::generate_clusters(int k, int maxiterations)
{
...
//  Description:
////////////////////////////////////////////////////////////////////
void BulletSoftBodyNode::release_clusters()
{
...
//  Description:
////////////////////////////////////////////////////////////////////
int BulletSoftBodyNode::get_num_clusters() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
void BulletSoftBodyNode::append_anchor(int node, BulletRigidBodyNode *body,
		bool disable)
{
...
////////////////////////////////////////////////////////////////////
int BulletSoftBodyNode::get_point_index(LVecBase3 p, PTA_LVecBase3 points)
{
...
////////////////////////////////////////////////////////////////////
int BulletSoftBodyNode::next_line(const char* buffer)
{
...
//  Description: 
////////////////////////////////////////////////////////////////////
void BulletSoftBodyNode::append_linear_joint(BulletBodyNode *body, int cluster,
...
//  Description: 
////////////////////////////////////////////////////////////////////
void BulletSoftBodyNode::append_linear_joint(BulletBodyNode *body,
...
//  Description: 
////////////////////////////////////////////////////////////////////
void BulletSoftBodyNode::append_angular_joint(BulletBodyNode *body,
		const LVector3 &axis, PN_stdfloat erp, PN_stdfloat cfm,
...
//  Description:
////////////////////////////////////////////////////////////////////
LVector3 BulletSoftBodyNode::get_wind_velocity() const
{
