...
//  Description:
////////////////////////////////////////////////////////////////////
BulletHeightfieldShape::BulletHeightfieldShape(const PNMImage &image,
		PN_stdfloat max_height, BulletUpAxis up)
{
	...
	for (int row = 0; row < _num_rows; row++)
	{
		...
		{
			_data[_num_cols * row + column] = max_height
					* image.get_bright(column, _num_cols - row - 1);
		}
	}

	_shape = new btHeightfieldTerrainShape(_num_rows, _num_cols, _data,
			max_height, up, true, false);
...
//  Description:
////////////////////////////////////////////////////////////////////
btCollisionShape *BulletHeightfieldShape::ptr() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
void BulletHeightfieldShape::set_use_diamond_subdivision(bool flag)
{
