...
//  Description:
////////////////////////////////////////////////////////////////////
BulletClosestHitRayResult::BulletClosestHitRayResult(const btVector3 &from_pos,
		const btVector3 &to_pos, const CollideMask &mask) :
		btCollisionWorld::ClosestRayResultCallback(from_pos, to_pos), _mask(
				mask)
{
...
//  Description:
////////////////////////////////////////////////////////////////////
bool BulletClosestHitRayResult::has_hit() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
PN_stdfloat BulletClosestHitRayResult::get_hit_fraction() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
const PandaNode *BulletClosestHitRayResult::get_node() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
LPoint3 BulletClosestHitRayResult::get_hit_pos() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
LVector3 BulletClosestHitRayResult::get_hit_normal() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
LPoint3 BulletClosestHitRayResult::get_from_pos() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
LPoint3 BulletClosestHitRayResult::get_to_pos() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
int BulletClosestHitRayResult::get_shape_part() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
int BulletClosestHitRayResult::get_triangle_index() const
{
