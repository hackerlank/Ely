...
//  Description:
////////////////////////////////////////////////////////////////////
int BulletTriangleMesh::get_num_triangles() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
void BulletTriangleMesh::add_triangle(const LPoint3 &p0, const LPoint3 &p1,
...
//  Description:
////////////////////////////////////////////////////////////////////
PN_stdfloat BulletTriangleMesh::get_welding_distance() const
{
		...
		bool remove_duplicate_vertices, const TransformState *ts)
{
	...
	GeomVertexReader reader = GeomVertexReader(vdata,
...
void BulletTriangleMesh::add_array(const PTA_LVecBase3 &points,
		const PTA_int &indices, bool remove_duplicate_vertices)
{
...
//  Description:
////////////////////////////////////////////////////////////////////
void BulletTriangleMesh::output(ostream &out) const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
void BulletTriangleMesh::write(ostream &out, int indent_level) const
{
	...
	for (int i = 0; i < array.size(); i++)
	{
		...
		indent(out, indent_level + 4) << "num triangles:"
				<< meshPart.m_numTriangles << endl;
		indent(out, indent_level + 4) << "num vertices:"
				<< meshPart.m_numVertices << endl;
	}
}
