...
#include "PhysicsComponents/BulletLocal/bulletDebugNode.h"
...
//  Description:
////////////////////////////////////////////////////////////////////
BulletDebugNode::BulletDebugNode(const char *name) :
		GeomNode(name)
{
...
////////////////////////////////////////////////////////////////////
bool BulletDebugNode::safe_to_flatten() const
{
...
////////////////////////////////////////////////////////////////////
bool BulletDebugNode::safe_to_transform() const
{
...
////////////////////////////////////////////////////////////////////
bool BulletDebugNode::safe_to_modify_transform() const
{
...
////////////////////////////////////////////////////////////////////
bool BulletDebugNode::safe_to_combine() const
{
...
//               is meaningful.
////////////////////////////////////////////////////////////////////
bool BulletDebugNode::safe_to_combine_children() const
{
...
////////////////////////////////////////////////////////////////////
bool BulletDebugNode::safe_to_flatten_below() const
{
...
//  Description: 
////////////////////////////////////////////////////////////////////
void BulletDebugNode::draw_mask_changed()
{
	...
	{
		int mode = DebugDraw::DBG_DrawText | DebugDraw::DBG_DrawFeaturesText
...
//  Description: 
////////////////////////////////////////////////////////////////////
void BulletDebugNode::sync_b2p(btDynamicsWorld *world)
{
...
//  Description: 
////////////////////////////////////////////////////////////////////
void BulletDebugNode::DebugDraw::setDebugMode(int mode)
{
...
//  Description: 
////////////////////////////////////////////////////////////////////
int BulletDebugNode::DebugDraw::getDebugMode() const
{
...
//  Description: 
////////////////////////////////////////////////////////////////////
void BulletDebugNode::DebugDraw::reportErrorWarning(const char *warning)
{
	PRINT_ERR_DEBUG(warning);
}
...
//  Description: 
////////////////////////////////////////////////////////////////////
void BulletDebugNode::DebugDraw::drawLine(const btVector3 &from,
		const btVector3 &to, const btVector3 &color)
{
	...
	line._p0 = LVecBase3((PN_stdfloat) from.getX(), (PN_stdfloat) from.getY(),
			(PN_stdfloat) from.getZ());
	line._p1 = LVecBase3((PN_stdfloat) to.getX(), (PN_stdfloat) to.getY(),
			(PN_stdfloat) to.getZ());
...
//  Description: 
////////////////////////////////////////////////////////////////////
void BulletDebugNode::DebugDraw::drawTriangle(const btVector3 &v0,
		...
		btScalar)
{
	...
	tri._p0 = LVecBase3((PN_stdfloat) v0.getX(), (PN_stdfloat) v0.getY(),
			(PN_stdfloat) v0.getZ());

	tri._p1 = LVecBase3((PN_stdfloat) v1.getX(), (PN_stdfloat) v1.getY(),
			(PN_stdfloat) v1.getZ());

	tri._p2 = LVecBase3((PN_stdfloat) v2.getX(), (PN_stdfloat) v2.getY(),
			(PN_stdfloat) v2.getZ());

	tri._color = UnalignedLVecBase4((PN_stdfloat) r, (PN_stdfloat) g,
			(PN_stdfloat) b, 1.0f);
...
////////////////////////////////////////////////////////////////////
void BulletDebugNode::DebugDraw::drawTriangle(const btVector3 &v0,
		const btVector3 &v1, const btVector3 &v2, const btVector3 &n0,
...
//  Description: 
////////////////////////////////////////////////////////////////////
void BulletDebugNode::DebugDraw::drawContactPoint(const btVector3 &point,
...
//  Description: 
////////////////////////////////////////////////////////////////////
void BulletDebugNode::DebugDraw::drawSphere(btScalar radius,
		const btTransform &transform, const btVector3 &color)
{
	...
	drawArc(center, xoffs, yoffs, radius, radius, 0, SIMD_2_PI, color, false,
			10.0);
	drawArc(center, yoffs, zoffs, radius, radius, 0, SIMD_2_PI, color, false,
			10.0);
	drawArc(center, zoffs, xoffs, radius, radius, 0, SIMD_2_PI, color, false,
			10.0);
}
