...
#include "PhysicsComponents/BulletLocal/bulletSliderConstraint.h"
...
BulletSliderConstraint::BulletSliderConstraint(
		const BulletRigidBodyNode *node_a, const TransformState *frame_a,
		bool use_frame_a)
{
...
////////////////////////////////////////////////////////////////////
BulletSliderConstraint::BulletSliderConstraint(
		const BulletRigidBodyNode *node_a, const BulletRigidBodyNode *node_b,
		...
		bool use_frame_a)
{
	...
	_constraint = new btSliderConstraint(*ptr_a, *ptr_b, trans_a, trans_b,
			use_frame_a);
}
...
//  Description:
////////////////////////////////////////////////////////////////////
btTypedConstraint *BulletSliderConstraint::ptr() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
PN_stdfloat BulletSliderConstraint::get_lower_linear_limit() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
PN_stdfloat BulletSliderConstraint::get_upper_linear_limit() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
PN_stdfloat BulletSliderConstraint::get_lower_angular_limit() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
PN_stdfloat BulletSliderConstraint::get_upper_angular_limit() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
PN_stdfloat BulletSliderConstraint::get_linear_pos() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
PN_stdfloat BulletSliderConstraint::get_angular_pos() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
void BulletSliderConstraint::set_target_linear_motor_velocity(
...
//  Description:
////////////////////////////////////////////////////////////////////
bool BulletSliderConstraint::get_powered_linear_motor() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
PN_stdfloat BulletSliderConstraint::get_target_linear_motor_velocity() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
PN_stdfloat BulletSliderConstraint::get_max_linear_motor_force() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
void BulletSliderConstraint::set_target_angular_motor_velocity(
		PN_stdfloat target_velocity)
{
...
//  Description:
////////////////////////////////////////////////////////////////////
bool BulletSliderConstraint::get_powered_angular_motor() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
PN_stdfloat BulletSliderConstraint::get_target_angular_motor_velocity() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
PN_stdfloat BulletSliderConstraint::get_max_angular_motor_force() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
void BulletSliderConstraint::set_frames(const TransformState *ts_a,
