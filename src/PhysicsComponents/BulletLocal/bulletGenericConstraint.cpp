		...
		bool use_frame_a)
{
	...
	_constraint = new btGeneric6DofConstraint(*ptr_a, *ptr_b, trans_a, trans_b,
			use_frame_a);
}
...
//  Description:
////////////////////////////////////////////////////////////////////
btTypedConstraint *BulletGenericConstraint::ptr() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
void BulletGenericConstraint::set_linear_limit(int axis, PN_stdfloat low,
		PN_stdfloat high)
{
...
//  Description:
////////////////////////////////////////////////////////////////////
void BulletGenericConstraint::set_angular_limit(int axis, PN_stdfloat low,
		PN_stdfloat high)
{
...
//  Description:
////////////////////////////////////////////////////////////////////
BulletRotationalLimitMotor BulletGenericConstraint::get_rotational_limit_motor(
		int axis)
{

	return BulletRotationalLimitMotor(
			*_constraint->getRotationalLimitMotor(axis));
}
...
//  Description:
////////////////////////////////////////////////////////////////////
BulletTranslationalLimitMotor BulletGenericConstraint::get_translational_limit_motor()
{

	return BulletTranslationalLimitMotor(
			*_constraint->getTranslationalLimitMotor());
}
...
//  Description:
////////////////////////////////////////////////////////////////////
void BulletGenericConstraint::set_frames(const TransformState *ts_a,
