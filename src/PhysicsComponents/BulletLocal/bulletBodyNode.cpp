...
#include "PhysicsComponents/BulletLocal/bulletBodyNode.h"
...
//  Description:
////////////////////////////////////////////////////////////////////
BulletBodyNode::BulletBodyNode(const char *name) :
		PandaNode(name)
{
...
////////////////////////////////////////////////////////////////////
CollideMask BulletBodyNode::get_legal_collide_mask() const
{
...
////////////////////////////////////////////////////////////////////
bool BulletBodyNode::safe_to_flatten() const
{
...
////////////////////////////////////////////////////////////////////
bool BulletBodyNode::safe_to_transform() const
{
...
////////////////////////////////////////////////////////////////////
bool BulletBodyNode::safe_to_modify_transform() const
{
...
////////////////////////////////////////////////////////////////////
bool BulletBodyNode::safe_to_combine() const
{
...
//               is meaningful.
////////////////////////////////////////////////////////////////////
bool BulletBodyNode::safe_to_combine_children() const
{
...
////////////////////////////////////////////////////////////////////
bool BulletBodyNode::safe_to_flatten_below() const
{
...
//  Description: 
////////////////////////////////////////////////////////////////////
void BulletBodyNode::output(ostream &out) const
{
...
void BulletBodyNode::remove_shape(BulletShape *shape)
{
	...
	{
		PRINT_ERR_DEBUG("shape not attached");
	}
	else
	{
		_shapes.erase(found);
...
////////////////////////////////////////////////////////////////////
bool BulletBodyNode::is_identity(btTransform &trans)
{

	btVector3 null(0, 0, 0);

	return (trans.getOrigin() == null && trans.getRotation().getAxis() == null);
}
...
////////////////////////////////////////////////////////////////////
void BulletBodyNode::shape_changed()
{
...
//  Description:
////////////////////////////////////////////////////////////////////
PN_stdfloat BulletBodyNode::get_deactivation_time() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
bool BulletBodyNode::is_active() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
void BulletBodyNode::set_active(bool active, bool force)
{
...
//  Description:
////////////////////////////////////////////////////////////////////
void BulletBodyNode::set_deactivation_enabled(const bool enabled,
		const bool force)
{
...
//  Description:
////////////////////////////////////////////////////////////////////
bool BulletBodyNode::is_deactivation_enabled() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
LVecBase3 BulletBodyNode::get_anisotropic_friction() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
bool BulletBodyNode::has_contact_response() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
PN_stdfloat BulletBodyNode::get_contact_processing_threshold() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
PN_stdfloat BulletBodyNode::get_ccd_swept_sphere_radius() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
PN_stdfloat BulletBodyNode::get_ccd_motion_threshold() const
{
...
////////////////////////////////////////////////////////////////////
void BulletBodyNode::set_transform_dirty()
{
