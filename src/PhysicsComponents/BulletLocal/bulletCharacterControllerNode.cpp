...
//  Description:
////////////////////////////////////////////////////////////////////
BulletCharacterControllerNode::BulletCharacterControllerNode(BulletShape *shape,
		PN_stdfloat step_height, const char *name) :
		BulletBaseCharacterControllerNode(name)
{
	...
	if (!shape->is_convex())
	{
		PRINT_ERR_DEBUG("a convex shape is required!");
		return;
	}
	...
	_character = new btKinematicCharacterController(_ghost, convex, step_height,
			_up);
...
//  Description:
////////////////////////////////////////////////////////////////////
void BulletCharacterControllerNode::set_linear_movement(
...
//  Description:
////////////////////////////////////////////////////////////////////
void BulletCharacterControllerNode::sync_p2b(PN_stdfloat dt, int num_substeps)
{
...
//  Description:
////////////////////////////////////////////////////////////////////
void BulletCharacterControllerNode::sync_b2p()
{
...
//  Description:
////////////////////////////////////////////////////////////////////
void BulletCharacterControllerNode::transform_changed()
{
...
//  Description:
////////////////////////////////////////////////////////////////////
BulletShape *BulletCharacterControllerNode::get_shape() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
bool BulletCharacterControllerNode::is_on_ground() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
bool BulletCharacterControllerNode::can_jump() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
void BulletCharacterControllerNode::do_jump()
{
...
//  Description:
////////////////////////////////////////////////////////////////////
void BulletCharacterControllerNode::set_max_jump_height(
		PN_stdfloat max_jump_height)
{
...
//  Description:
////////////////////////////////////////////////////////////////////
PN_stdfloat BulletCharacterControllerNode::get_max_slope() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
PN_stdfloat BulletCharacterControllerNode::get_gravity() const
{
