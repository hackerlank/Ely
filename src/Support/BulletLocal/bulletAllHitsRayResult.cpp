...
#include "Support/BulletLocal/bulletAllHitsRayResult.h"
...
BulletAllHitsRayResult::BulletAllHitsRayResult(const btVector3 &from_pos,
		...
		btCollisionWorld::AllHitsRayResultCallback(from_pos, to_pos), _mask(
				mask)
{
		...
		btCollisionWorld::LocalRayResult& rayResult, bool normalInWorldSpace)
{
	...
	return btCollisionWorld::AllHitsRayResultCallback::addSingleResult(
...
//  Description:
////////////////////////////////////////////////////////////////////
LPoint3 BulletAllHitsRayResult::get_from_pos() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
LPoint3 BulletAllHitsRayResult::get_to_pos() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
PN_stdfloat BulletAllHitsRayResult::get_closest_hit_fraction() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
int BulletAllHitsRayResult::get_num_hits() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
PN_stdfloat BulletRayHit::get_hit_fraction() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
LPoint3 BulletRayHit::get_hit_pos() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
LVector3 BulletRayHit::get_hit_normal() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
int BulletRayHit::get_shape_part() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
int BulletRayHit::get_triangle_index() const
{
