...
BulletWheel BulletVehicle::create_wheel()
{
	...
	btWheelInfo &info = _vehicle->addWheel(pos, direction, axle, suspension,
			radius, _tuning._, false);
...
//  Description:
////////////////////////////////////////////////////////////////////
btVector3 BulletVehicle::get_axis(int idx)
{
