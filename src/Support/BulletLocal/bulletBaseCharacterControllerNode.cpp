...
//  Description:
////////////////////////////////////////////////////////////////////
BulletBaseCharacterControllerNode::BulletBaseCharacterControllerNode(
		const char *name) :
		PandaNode(name)
{
...
////////////////////////////////////////////////////////////////////
CollideMask BulletBaseCharacterControllerNode::get_legal_collide_mask() const
{
...
////////////////////////////////////////////////////////////////////
bool BulletBaseCharacterControllerNode::safe_to_flatten() const
{
...
////////////////////////////////////////////////////////////////////
bool BulletBaseCharacterControllerNode::safe_to_modify_transform() const
{
...
////////////////////////////////////////////////////////////////////
bool BulletBaseCharacterControllerNode::safe_to_combine() const
{
...
//               is meaningful.
////////////////////////////////////////////////////////////////////
bool BulletBaseCharacterControllerNode::safe_to_combine_children() const
{
...
////////////////////////////////////////////////////////////////////
bool BulletBaseCharacterControllerNode::safe_to_flatten_below() const
{
...
////////////////////////////////////////////////////////////////////
bool BulletBaseCharacterControllerNode::safe_to_transform() const
{
