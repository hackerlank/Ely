...
BulletHingeConstraint::BulletHingeConstraint(const BulletRigidBodyNode *node_a,
		const TransformState *ts_a, bool use_frame_a)
{
...
////////////////////////////////////////////////////////////////////
BulletHingeConstraint::BulletHingeConstraint(const BulletRigidBodyNode *node_a,
		const BulletRigidBodyNode *node_b, const TransformState *ts_a,
		const TransformState *ts_b, bool use_frame_a)
{
	...
	_constraint = new btHingeConstraint(*ptr_a, *ptr_b, frame_a, frame_b,
			use_frame_a);
}
...
////////////////////////////////////////////////////////////////////
BulletHingeConstraint::BulletHingeConstraint(const BulletRigidBodyNode *node_a,
		const LPoint3 &pivot_a, const LVector3 &axis_a, bool use_frame_a)
{
...
////////////////////////////////////////////////////////////////////
BulletHingeConstraint::BulletHingeConstraint(const BulletRigidBodyNode *node_a,
		const BulletRigidBodyNode *node_b, const LPoint3 &pivot_a,
		const LPoint3 &pivot_b, const LVector3 &axis_a, const LVector3 &axis_b,
		bool use_frame_a)
{
	...
	_constraint = new btHingeConstraint(*ptr_a, *ptr_b, pos_a, pos_b, vec_a,
			vec_b, use_frame_a);
}
...
//  Description:
////////////////////////////////////////////////////////////////////
btTypedConstraint *BulletHingeConstraint::ptr() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
bool BulletHingeConstraint::get_angular_only() const
{
...
//               degrees.
////////////////////////////////////////////////////////////////////
void BulletHingeConstraint::set_limit(PN_stdfloat low, PN_stdfloat high,
		PN_stdfloat softness, PN_stdfloat bias, PN_stdfloat relaxation)
{
...
void BulletHingeConstraint::enable_angular_motor(bool enable,
		PN_stdfloat target_velocity, PN_stdfloat max_impulse)
{
...
//  Description:
////////////////////////////////////////////////////////////////////
void BulletHingeConstraint::set_motor_target(const LQuaternion &quat,
		PN_stdfloat dt)
{
...
//  Description:
////////////////////////////////////////////////////////////////////
void BulletHingeConstraint::set_motor_target(PN_stdfloat target_angle,
		PN_stdfloat dt)
{
...
//  Description:
////////////////////////////////////////////////////////////////////
void BulletHingeConstraint::set_frames(const TransformState *ts_a,
