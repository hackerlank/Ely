...
//  Description:
////////////////////////////////////////////////////////////////////
BulletBoxShape::BulletBoxShape(const LVecBase3 &halfExtents)
{
...
//  Description:
////////////////////////////////////////////////////////////////////
btCollisionShape *BulletBoxShape::ptr() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
LVecBase3 BulletBoxShape::get_half_extents_without_margin() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
LVecBase3 BulletBoxShape::get_half_extents_with_margin() const
{
...
//  Description:
////////////////////////////////////////////////////////////////////
BulletBoxShape *BulletBoxShape::make_from_solid(const CollisionBox *solid)
{
	...
	LVecBase3 extents(p1.get_x() - p0.get_x() / 2.0,
			p1.get_y() - p0.get_y() / 2.0, p1.get_z() - p0.get_z() / 2.0);
