...
bool OgreFramework::initOgre(Ogre::String wndTitle,
		OIS::KeyListener *pKeyListener, OIS::MouseListener *pMouseListener)
{
	...
	m_pKeyboard = static_cast<OIS::Keyboard*>(m_pInputMgr->createInputObject(
			OIS::OISKeyboard, true));m_pMouse
	= static_cast<OIS::Mouse*>(m_pInputMgr->createInputObject(OIS::OISMouse,
			true));
...
m_pMouse	->getMouseState().height = m_pRenderWnd->getHeight();
	...
	m_pTrayMgr = new OgreBites::SdkTrayManager("AOFTrayMgr", m_pRenderWnd,
			m_pMouse, 0);
...
bool OgreFramework::mousePressed(const OIS::MouseEvent &evt,
...
bool OgreFramework::mouseReleased(const OIS::MouseEvent &evt,
		OIS::MouseButtonID id)
{
	return true;
}
